...
> Companion to `../visual-style.md` (prose/intent) and
> `../storytelling-cheatsheet.md` (vocabulary). **This file is the testable
...
| ID | Rule (creation) | Check (review) | Type | Sev |
|---|---|---|---|---|
| B1 | Palette is the approved set only | Every color literal ∈ `visual-style.md` palette | `SRC` | BLOCK |
